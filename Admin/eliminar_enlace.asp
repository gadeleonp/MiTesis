...
<body>
<h1 align="center" >Eliminar Enlace</h1>
<br>
<form name="form1" method="post" action="elimina_enlace.asp">
<br>
<%
	 if not rs.eof then
%>
...
%>
<tr>
<td class="celdaBgBlue05"><input name="id" type="checkbox" value="<%=rs("id")%>"></td>
